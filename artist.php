			...
			<form id="contactform" action="addartist.php" method="post">
				<div class="form">
					<table width="auto" align="center">
						<tr>
							<td>
							<input type="text" name="id" placeholder="Artist ID">
							</td>
						</tr>
						<tr>
							<td>
							<select name="gnd">
								<option value="0">Artist Gender</option>
						...
						<tr>
							<td>
							<input type="text" name="birthp" placeholder="Artist Birthplace">
							</td>
						</tr>
						<tr>
							<td>
							<input type="text" name="style" placeholder="Style of Art">
							</td>
						</tr>
						<tr>
							<td>
							<input type="text" name="age" placeholder="Artist Age">
							</td>
						</tr>
						<tr>
							<td>
